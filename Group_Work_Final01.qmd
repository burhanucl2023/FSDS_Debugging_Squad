...
The data on @insideairbnb was collected by the Inside Airbnb Project team, which is led by Murray Cox, an artist, activist and technologist. 

## 2. Why did they collect it?

Airbnb is a company providing a peer to peer platform for short-term rental (STR) accommodations in cities around the world with over 4 million active hosts today. (https://news.airbnb.com/about-us/). 

The Inside Airbnb Project has two objectives 

1.	Make data on Airbnb listings available for analysis and research to quantify the impact of STR on local communities.
    
3.	Provide a platform for community members, researchers, activists or policy makers to support policy and regulation that limits adverse impacts of Airbnb STR on local communities. 

(http://insideairbnb.com/data-policies).

## 3. How was the data collected?  

The data on Inside Airbnb was collected through a process of web scraping. Data on individual listings is extracted from the Airbnb website for different cities. Inside Airbnb has collected data for 92 cities in Europe and North America and 21 cities in Asia and the Pacific, Africa, South America. For each listing, a range of data points is collected including on the host, location, property and room type, price, stay, and reviews. The collected data is verified, cleansed, analysed and aggregated by the Inside Airbnb project team and stored in a csv files for each city, which is made available for downloading.  The process of web scraping is usually repeated 4 times a year. So, there a four data sets per city per year. 
...
-	Airbnb prohibits  data scraping in its terms and conditions (T&Cs). However, to be legally binding T&Cs require an agreement  from both parties. Logging into the website is considered as an agreement to the T&Cs. However, web scraping is an automated process without logging in and is hence considered legal.  Legalities of Airbnb API Scraping (airbtics.com)

-	The data collected includes personal information, e.g.,  images and names of hosts and their homes. Hosts did not give consent for their data to be included in the Inside Airbnb Project, however one could argue, that by making their data public on Airbnb they gave up data protection rights on this information.
  
-	Geocoded data is especially sensitive information.Showing negative impacts of Aibnb listing while also disclosing the location of these listings, may pose a safety risk to hosts. Airbnb mitigates this risk by anonymizing listings on the map, the location is within 150 metres of the actual address. https://www.tandfonline.com/doi/full/10.1080/03098265.2018.1436534
  
-	As argued by post-colonial scholars, there tends to be more data and research about cities in the global north and a need to better understand spatial processes in cities of the global south, including those related to digital technologies, such as Airbnb. The Inside Airbnb Project has collected more data on cities in the Global North than cities in the Global South. Analysis using these data sets may be less suitable to describe the impact of cities in the Global South. https://www.tandfonline.com/doi/full/10.1080/0966369X.2018.1465396
